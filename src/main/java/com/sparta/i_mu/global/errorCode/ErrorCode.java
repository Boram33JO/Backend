...
public enum ErrorCode {
    ...
    KAKAO_UNLINK_FAILED(40015, HttpStatus.BAD_REQUEST, "카카오 연결 해제에 실패했습니다."),
    DATABASE_PROCESSING_ERROR(5001, HttpStatus.INTERNAL_SERVER_ERROR, "데이터를 deleted 처리하는 과정에서 오류가 발생했습니다.");
